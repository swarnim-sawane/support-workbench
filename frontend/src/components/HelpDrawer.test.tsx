...
describe('HelpDrawer', () => {
  ...
  it('renders JD MCP status, available tools, and unavailable reasons', () => {
    render(
      <HelpDrawer
        open
        ...
        jdMcp={{
          available: true,
          connected: false,
          note: 'jd-mcp tools are recognized, but some prerequisites are still missing.',
    ...
    const section = screen.getByRole('region', { name: /jd mcp tools/i });
